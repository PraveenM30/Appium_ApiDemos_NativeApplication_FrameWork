...
public class BaseClassOriginal {
	...
	/* ---------StartAppiumServer and Application---------------------------------------------------------------------------------------------------------------*/
		...
		public void StartAppiumAndInvokeApp() throws IOException {
			...
			options.setApp(
					"C:\\Users\\user\\eclipse-workspace\\Appium_APIDemos(Native Application)_FrameWork\\org.Resources\\ApiDemos-debug (1).apk");
	        options.setCapability("autoGrantPermissions", true); // Grant permissions automatically
	...
	/* ------------------------GetJsonData---------------------------------------------------------------------------------------------------------------*/
		...
		public Object[][] getJSONData() throws IOException {
			...
			List<HashMap<String, String>> data = getJsonData(
					System.getProperty("user.dir") + "\\src\\main\\java\\org\\TestData\\APIDemos.json");
